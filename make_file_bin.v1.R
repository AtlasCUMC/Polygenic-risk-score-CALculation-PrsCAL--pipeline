...
f6 <-cbind(f6$IID, f6$Age, f6$Sex, f6$PC1, f6$PC2 ,f6$PC3,f6$PC4,f6$PRS,f6$Stand_PRS,f6$ZScore,f6$pheno,f6$scoreBin20,f6$scoreBin100,f6$T2DM)

colnames(f6) <- c("id", "Age", "Sex", "PC1", "PC2", "PC3" ,"PC4", "PRS", "Stand_PRS", "ZScore", "Pheno", "scoreBin20" , "scoreBin100", "T2DM")
