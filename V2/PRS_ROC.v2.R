...
GLM <- glm(Pheno~Age+Site+PC1+PC2+PC3+PC4+T2DM, family=binomial(link="logit"), data=Ldpred_validate)



roc.data <-roc(GLM$y , GLM$fitted.values,ci=T)

cat ("NOTICE: Only Covariates AUC!", "\n")

print(roc.data)

#print(paste("Only covariates AUC:",roc.data))
